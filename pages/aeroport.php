          ...
          <div id="aile">
             ...
             <form class="formulaire2" method="post" action="#"><br>
                  ...
                  <select value="choisir un aeroport">
                    ...
                    <option value="2"> aeroport charles Degaule</option>
                    <option value="3"> aeroport orly(sud)</option>
                  </select><br>
                  ...
                  <select class="two" name="aeroports" id='selection'>
                    <option value="1">choississez</option>
                    <option value="2">aeroport charles degaule</option>
                    <option value="3">aeroport orly</option>
                  </select><br>
                  <label for="">etape dans le trajet :</label>
                   ...
                   <input type="submit" id='validation'name="" value="valider ma commande">
